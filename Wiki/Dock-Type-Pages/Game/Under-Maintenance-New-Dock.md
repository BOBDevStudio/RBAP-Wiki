...
page_subject_info:
  ...
  main_image:
    path: "/Assets/Images/Dock-Types/Under-Maintenance-New-Dock.png"
#  description: ""
  data:
...
<img class="dock-type-image" src="/RBAP-Wiki/Assets/Images/Dock-Types/Under-Maintenance-New-Dock.png" alt="">