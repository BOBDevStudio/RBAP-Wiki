...
The Rainbow Dance Floor dock is another classic dock. It features a dance floor that cycles through colors of the rainbow repeatedly. This dock is the only dock currently in the game that was not originally a dock and wasn't one for quite some time until [`V3`]({{- "/Posts/Update-Log/3-0-0" | relative_url -}}) rolled around. In [`V3`]({{- "/Posts/Update-Log/3-0-0" | relative_url -}}) it was made into a dock for the never fully released rainbow parties. 
