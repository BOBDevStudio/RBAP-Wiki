...
* The backend of the server and game info dock (or server system dock for short) has been completely recoded from scratch. Due to this some statistics have been removed.
...
* * The new system has the natively supported ability of live updating titles. This will be used in an upcoming update!
...
* The revamped game rooms dock has been added back after being quietly removed in V3.1 due to my unwillingness to finally finish it. Here's a list of everything different from when it was added in V3 (and pretending like it was enabled when it was added):
