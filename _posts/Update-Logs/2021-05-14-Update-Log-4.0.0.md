...
* The old [Game Rooms Dock](/RBAP-Wiki/Wiki/Docks/Game-Rooms-Dock) now has a date that it will not appear in new servers after. RIP old [Game Rooms Dock](/RBAP-Wiki/Wiki/Docks/Game-Rooms-Dock) 2018-2021.
...
* Both the rainbow dance floor dock and the [Game Rooms Dock](/RBAP-Wiki/Wiki/Docks/Game-Rooms-Dock) don't (for now at least) have their own music. This is due to technical reasons like how music zones aren't bound to any dock.
