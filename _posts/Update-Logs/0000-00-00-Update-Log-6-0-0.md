...
* Putting either a tab character or new line character will no longer return an error. In the case of tab characters they will be replaced with a single space character and as for new line characters they will just be removed.
