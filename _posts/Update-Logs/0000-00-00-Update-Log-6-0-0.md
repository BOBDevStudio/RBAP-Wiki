...
* * Removed support for the [Techtation](https://www.roblox.com/games/6201734639/) integration added in [`V3.1`]({{- "/wiki/posts/update-log/3-1-0" | relative_url -}}). Now as of 2/15/2020 when you go to the doors to the game in [Techtation](https://www.roblox.com/games/6201734639/) no action pop-up will appear.
