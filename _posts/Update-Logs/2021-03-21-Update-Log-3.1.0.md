...
* My/{% include BOB.html %}'s new showcase called [Techtation](https://www.roblox.com/games/6201734639/) has been directly integrated into the game.
...
* * * Input: `local Answer = QuestionAnswerer("Did {% include BOB.html %} write this question?") print(Answer)`
