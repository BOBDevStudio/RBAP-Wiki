...
short_description: "This update is so impactful it can't even be summarized within the character limit of this line of text."
...
Output: <s class="spoiler"><code>BOB is the creator (and owner) of this game and he has also created most stuff in this game`</s>
