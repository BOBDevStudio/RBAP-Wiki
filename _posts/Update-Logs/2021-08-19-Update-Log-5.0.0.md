...
* * Most notable is because of the remodel dock types now the ability to control some new lights that I like to call warning lights. As of this update only 3 (new) dock types use it.
