...
* * Once it turns the 24th of any month UTC the dock will be placed in all existing and new servers. At 11:45 PM the dock entrance's dock type will be changed. Then at midnight the gate of the dock entrance will be raised. Finally at 15 minutes after the gate is raised the dock will be removed.
* * * Each of these timed event has a margin of error of at most a minute (not counting the accuracy of lua API).
