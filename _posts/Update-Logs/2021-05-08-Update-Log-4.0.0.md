...
Output: <s class="spoiler"><code><div class="no-format" style="color:rgb(255,0,0)">Y</div><div class="no-format" style="color:rgb(0,255,0)">e</div><div class="no-format" style="color:rgb(0,0,255)">s</div>!</code></s>
* * * Input: `local Answer = QuestionAnswerer("What's BOB's favorite color?") print(Answer)`
Output: <s class="spoiler"><code><font color="rgb(0,255,255)">This one currently!</font> A previous one was <font color="rgb(0,0,255)">this one</font> in around 2017 to 2018</code></s>
