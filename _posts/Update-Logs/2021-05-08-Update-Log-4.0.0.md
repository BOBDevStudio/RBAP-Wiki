...
Output: <s class="spoiler">`Hello from a function!`</s>
* * * Input: `print(math.random(1, 9999999999))`
Output: <s class="spoiler">`😵`</s>
* * * Input: `print(Shrug)`
Output: <s class="spoiler">`¯\_(ツ)_/¯`</s>
* * * Input: `local Answer = QuestionAnswerer("Does this console have some more RGB?") print(Answer)`
Output: <s class="spoiler">`<font color="rgb(255,0,0)">Y</font><font color="rgb(0,255,0)">e</font><font color="rgb(0,0,255)">s</font>!`</s>
* * * Input: `local Answer = QuestionAnswerer("What's BOB's favorite color?") print(Answer)`
Output: <s class="spoiler">`<font color="rgb(0,255,255)">This one currently!</font> A previous one was <font color="rgb(0,0,255)">this one</font> in around 2017 to 2018`</s>
* * * Input: `if SSIntroE then print("Hmm...") end`
Output: <s class="spoiler">`Hmm...`</s>
* * * Input: `print(game.PlaceId)`
Output: <s class="spoiler">`{game.PlaceId}`</s>
* * * Input: `print(game.ClassName)`
Output: <s class="spoiler">`{game.ClassName}`</s>
* * * Input: `print(typeof(game))`
Output: <s class="spoiler">`{typeof(game)}`</s>
* * * Input: `print(type(game))`
Output: <s class="spoiler">`{type(game)}`</s>
