...
* * The new system has the natively supported ability of live updating titles. This will be used in an upcoming update ([`V4.1`]({{- "/Posts/Update-Log/4-1-0" | relative_url -}}))!
